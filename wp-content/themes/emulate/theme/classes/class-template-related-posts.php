...
class Twoot_Template_Related_Posts {
	...
	*/
	public function carousel()
	{
		...
		// Output HTML
		$html = '<div class="the-carousel-list the-grid-list related-works mt inner">';
		...
		while( $this->entries->have_posts() ) {
			...
			$html .= '<li class="item post-item column">';
	...
	*/
	public function grid()
	{
		...
		// Output HTML
		$html = '<div class="the-grid-list related-works mt inner">';
		$html .= '<h5 class="section-title">'.$title.'</h5>';
	...
	*/
	public function post()
	{
		...
		// Output HTML
		$html = '<div class="related-posts mt">';
		$html .= '<h5 class="section-title">'.$title.'</h5>';
		$html .= '<div class="outer">';
