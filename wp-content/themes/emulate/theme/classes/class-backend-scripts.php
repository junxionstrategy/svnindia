...
class Twoot_Admin_Scripts {
	...
	*/
	...
	public function CSS() {
		...
		if ( in_array( $screen->id, array( 'appearance_page_theme_opt', 'appearance_page_theme_skin', 'appearance_page_theme_font', 'edit-post', 'post', 'edit-page', 'page', 'edit-portfolio', 'portfolio', 'edit-faq', 'faq', 'edit-testimonial', 'testimonial', 'edit-category', 'edit-post_tag', 'edit-portfolio_cat', 'edit-portfolio_tag', 'edit-faq_cat', 'widgets' ) ) ) {
	...
	public function JS() {
		...
		if ( in_array( $screen->id, array( 'appearance_page_theme_opt', 'appearance_page_theme_skin', 'appearance_page_theme_font', 'edit-post', 'post', 'edit-page', 'page', 'edit-portfolio', 'portfolio', 'edit-faq', 'faq', 'edit-testimonial', 'testimonial' ) ) ) {
	 ...
	 */
	 public function TYPE_CSS() {
		...
		if ( in_array( $screen->id, array( 'edit-faq', 'faq' ) ) ) {
