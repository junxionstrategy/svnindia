...
* @since   1.0.0
*/
function twoot_single_navigation() { 
	?>
	<nav class="single-navigation clearfix">
		<div class="nav-previous column six"><?php previous_post_link('%link', __( '<span class="meta-nav">&lsaquo;</span> Older post', 'Twoot' ) ); ?></div>
		<div class="nav-next column six"><?php next_post_link('%link', __( 'Newer post <span class="meta-nav">&rsaquo;</span>', 'Twoot' ) ); ?></div>
	</nav><!-- # .navigation -->
	<?php
}
...
if ( function_exists('register_sidebar') ) {
	$sidebars = array(
		...
		'contact' => esc_attr__('Contact', 'Twoot'), 
