...
function twoot_add_posts() {
	...
	* @var     string
	*/
	twoot_add_post( 'page', esc_sql( _x('home', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_home_id', esc_attr__('Home', 'Twoot'), $data['template_home_v1'] );
		...
		* @var     string
		*/
		twoot_add_post( 'page', esc_sql( _x('home-v2', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_home_v2_id', esc_attr__('Home V2', 'Twoot'), $data['template_home_v2'], get_option(TWOOT_PREFIX . 'template_home_id')  );
		...
		* @var     string
		*/
		twoot_add_post( 'page', esc_sql( _x('home-v3', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_home_v3_id', esc_attr__('Home V3', 'Twoot'), $data['template_home_v3'], get_option(TWOOT_PREFIX . 'template_home_id')  );
		...
		* @var     string
		*/
		twoot_add_post( 'page', esc_sql( _x('home-v4', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_home_v4_id', esc_attr__('Home V4', 'Twoot'), $data['template_home_v4'], get_option(TWOOT_PREFIX . 'template_home_id')  );
	...
	*/
	twoot_add_post( 'page', esc_sql( _x('pages', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_pages_id', esc_attr__('Pages', 'Twoot'), '' );
		...
		* @var     string
		*/
		twoot_add_post( 'page', esc_sql( _x('contact', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_contact_id', esc_attr__('Contact', 'Twoot'), '', get_option(TWOOT_PREFIX . 'template_pages_id') );
		...
		* @var     string
		*/
		twoot_add_post( 'page', esc_sql( _x('faq', 'page_slug', 'Twoot') ), TWOOT_PREFIX . 'template_faq_id', esc_attr__('FAQ', 'Twoot'), '', get_option(TWOOT_PREFIX . 'template_pages_id') );
